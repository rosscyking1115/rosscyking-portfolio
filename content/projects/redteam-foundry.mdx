...
summary: "Adversarial benchmark foundry for LLM safety (pip install redteam-foundry): attack-corpus audits, defence-impact measurement, staleness scoring, and over-refusal tests against 2026-era LLMs — with cross-judge validation and bootstrap confidence intervals."
stack:
  [
    Python,
    Claude Sonnet 4.6,
