...
summary: Synthetic evaluation lab for testing internal AI agent reliability — grounded retrieval, structured extraction, safe refusal, approval-gated tools, and observability — with a public Streamlit dashboard and GitHub Pages report site.
stack:
  [
    Python,
    FastAPI,
