...
- The four-layer warehouse ran once on BigQuery under a £10 approved cap: 68 dbt models and 217 tests green. The older 13-table / 107-check run is kept as history, not passed off as current.
