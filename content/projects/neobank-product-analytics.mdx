...
It shows end-to-end data product thinking: warehouse design, model scoring, experiment analysis, dashboarding, and operational handoff — not a one-off notebook.
