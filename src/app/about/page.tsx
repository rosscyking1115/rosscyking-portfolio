...
export const metadata: Metadata = {
  title: "About",
  description:
    "MSc Artificial Intelligence at the University of Sheffield. I build data and ML systems you can audit: tested pipelines, honest evaluation, and evidence you can trace back to where it came from.",
